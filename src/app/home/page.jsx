    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.content}>
                ...
                <p className={styles.descriptioncontent}>A API consiste em um sistema de gerenciamento de alunos, onde é possível visualizar, adicionar, editar e remover alunos. Ela será integrada a esta aplicação Front-End mostrando os dados de um aluno. </p>
                <Link href="/sala" prefetch>
                    <button type="primary" className={styles.button}>Ver Alunos!</button>
                </Link>
            </div>
        </div>
    );
